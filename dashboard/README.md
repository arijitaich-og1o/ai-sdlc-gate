...
_Generated 2026-09-20T20:14:56+00:00 from 34 gate run(s)._
...
| Gate runs | 34 |
| Pass rate | 35% |
| Runs flagged (findings at/above threshold) | 17 (50%) |
| Runs blocked | 22 (65%) |
| Skips requested / granted | 3 / 3 |
| Findings waived via skips | 0 |
| Findings per run | 3.91 |
| Runs with local client attestation | 15% |
| Active developers / repositories | 4 / 7 |
...
| marlene.graefe@og1o.de (@arijitaich-og1o) | 2 | 50% | 0 | 1 | 0/0 | 0 | 0.0 | 0% | - | 2026-09-20 |
...
| oneo-dice/oggpt-x-backend | 2 | 50% | 1 | 0 | 1 | 0.0 | - |

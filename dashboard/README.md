...
_Generated 2026-09-20T20:35:16+00:00 from 35 gate run(s)._
...
| Gate runs | 35 |
| Pass rate | 34% |
| Runs flagged (findings at/above threshold) | 17 (49%) |
| Runs blocked | 23 (66%) |
| Skips requested / granted | 3 / 3 |
| Findings waived via skips | 0 |
| Findings per run | 3.8 |

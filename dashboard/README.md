...
_Generated 2026-09-14T06:09:53+00:00 from 18 gate run(s)._
...
| Gate runs | 18 |
| Pass rate | 56% |
| Runs flagged (findings at/above threshold) | 8 (44%) |
| Runs blocked | 8 (44%) |
| Skips requested / granted | 0 / 0 |
| Findings waived via skips | 0 |
| Findings per run | 4.22 |
| Runs with local client attestation | 22% |
...
|---|---|---|---|---|---|---|---|
| 2026-09 | 18 | 56% | 8 | 0 | 24 | 9 | 27 |

## Developers

| Developer | Runs | Pass rate | Flagged | Blocked | Skips req/granted | Waived findings | Findings/run | Client attested | Top categories | Last seen |
|---|---|---|---|---|---|---|---|---|---|---|
| arijit.aich@og1o.in (@arijitaich-og1o) | 11 | 46% | 6 | 6 | 0/0 | 0 | 4.73 | 36% | hardcoded-credential, data-protection-design-gap, general | 2026-09-10 |
...
| OG-DW/rmscontextual_api | 4 | 100% | 0 | 0 | 2 | 3.0 | authz-design-gap, undocumented-decision, observability-gap |

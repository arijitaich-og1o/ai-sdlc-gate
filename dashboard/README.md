...
_Generated 2026-09-14T06:08:30+00:00 from 17 gate run(s)._
...
| Gate runs | 17 |
| Pass rate | 53% |
| Runs flagged (findings at/above threshold) | 8 (47%) |
| Runs blocked | 8 (47%) |
...
|---|---|---|---|---|---|---|---|
| 2026-09 | 17 | 53% | 8 | 0 | 24 | 9 | 25 |

## Developers

| Developer | Runs | Pass rate | Flagged | Blocked | Skips req/granted | Waived findings | Findings/run | Client attested | Top categories | Last seen |
|---|---|---|---|---|---|---|---|---|---|---|
| arijit.aich@og1o.in (@arijitaich-og1o) | 10 | 40% | 6 | 6 | 0/0 | 0 | 4.9 | 30% | hardcoded-credential, data-protection-design-gap, general | 2026-09-10 |
...
| OG-DW/rmscontextual_api | 3 | 100% | 0 | 0 | 2 | 3.0 | authz-design-gap, undocumented-decision, observability-gap |
